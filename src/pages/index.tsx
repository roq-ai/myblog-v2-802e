...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`MyBlog v2`}</title>

        <meta
          name="description"
          content="Welcome to MyBlog v2, your personal webpage builder with an integrated blog. Manage your homepage, blog items, and contacts effortlessly through our user-friendly GUI."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MyBlog v2, your personal webpage builder with an integrated blog. Manage your homepage, blog items, and contacts effortlessly through our user-friendly GUI.`}
            </Text>
            <Box
