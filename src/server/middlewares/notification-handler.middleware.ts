...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'OrderID', tenantPath: [], userPath: [] },
  'Product.update': { roles: ['tenant-roles'], key: 'ProductID', tenantPath: [], userPath: [] },
  'Feedback.create': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'FeedbackID', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['owner', 'administrator', 'visitor'];
